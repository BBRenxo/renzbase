...
namespace Patches {
    namespace Update {
        ...
        inline uintptr_t newCheck1 = 0x561D90;
        inline uintptr_t newCheck2 = 0x5566F0;
        inline uintptr_t newCheck3 = 0x2CBFC0;
        inline uintptr_t newCheck4 = 0x519B10;
    }
    ...
    inline std::vector<Patch> patches = {
        ...
        {{Update::controlFlowGuard},         {0xFF, 0xE0, 0xC3, 0x90, 0x90, 0x90, 0x90, 0x90}},    // JMP RAX ; RET ; NOP x5
        ...
        // NEW SINGLETON RETS
        {{Update::newCheck1}, {0xC3}},
        {{Update::newCheck2}, {0xC3}},
        {{Update::newCheck3}, {0xC3}},
        {{Update::newCheck4}, {0xC3}},
    };
}

// u p d a t e d  b y  o r a c l e
